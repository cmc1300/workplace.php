							...
							<input type="hidden" name="contact_id" value="{$contactObj->contact_id}">
									...
									{section name=contact loop=$contact_list}
										{section name=contactlist loop=$contactList}
												...
												{/if}
										{/section}
									{$contact_list[contact]->contact_list_name}<input type="checkbox" {$checked} name="contact_list_id[]" id="contact_list_id" value="{$contact_list[contact]->contact_list_id}"/>&nbsp;
									{/section}
									</p>
									<p>
									...
									<p>
										...
										<input class="text-input small-input"type="text" name="contact_surname" id="contact_list_name" value="{$contactObj->contact_surname}"/>
									</p>
									<p>
