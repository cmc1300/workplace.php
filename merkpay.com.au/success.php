						...
						<div class="row-fluid container" style="height:240px">
							<div class="content">
								...
								<!--  <h2>用户<?php echo $wechatid?>，您好:</h2>
									<h4>感谢您从<?php echo  $companyid?>订购了<?php echo $itemid?>  ，您已经成功支付了$<?php echo $amount?>。</h4>
								</div>
								-->
								<h2>Dear Customer:</h2>
									<h4>Thank you for your purchase of $<?php echo $amount?>AUD at <?php echo  $companyid?>.</h4>
								</div>
