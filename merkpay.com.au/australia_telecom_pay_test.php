...
<head>
  <meta charset="utf-8">
  <title>MerkPay - secure payment gateway</title>
      ...
      <div class="row-fluid bb-bookblock" id="bb-bookblock">
        ...
        <div class="row-fluid container">
          <div class="content">
            ...
            <div class="control-group row-fluid fluid" style="padding-bottom: 15px; border-bottom: 1px #999 solid;">
          ...
          <hr>	
          			<div style="float:left;">
						<a href="alipay/index.php" target="_blank"><img style="position:inherit;max-width: 100px;" src="img/btn_alipay.png"></a>
                    </div>
                    
                    <div style="float:left; margin-left:10px;">
						<a href="#" onclick="loadUnionPay()"><img style="position:inherit;max-width: 60px;" src="img/unionpay_avater.png"></a>
                    </div>
                    
                    <div style="float:right;margin-left:10px;">
                    	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="ULTFTPFTH5D78">
						<input type="image" style="max-width: 150px;" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
...
<!-- End .row-fluid -->
   ...
   function submmitform(){
    ...
    <script type='text/javascript'>
		...
		function loadUnionPay(){
			
				window.location = "unionpay/midpay.php?orderAmount="+$("#amount").val();
		}
