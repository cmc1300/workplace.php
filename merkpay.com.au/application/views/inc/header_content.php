...
<body>
	...
	<div id="sidebar" class="collapse">
		<div class="logo">
			<a href="index.html"style="background: url(<?php echo base_url();?>/images/tenpay3.png) 0 0 no-repeat;"></a>
		</div>
		<ul id="sidebar_menu" class="navbar nav nav-list sidebar_box">
			<li class="accordion-group"><a class="dashboard" href="<?php echo site_url('dashboard');?>"><img
			...
			<li class="accordion-group "><a 
				...
				<ul id="collapse1" class="accordion-body collapse">
					<li><a href="<?php echo site_url('transaction');?>">Transaction History</a></li>
					<li><a href="<?php echo site_url('withdraw/withdraw_form');?>">Withdraw Request</a></li>
					<li><a href="<?php echo site_url('withdraw/withdraw_history');?>">Withdraw History</a></li>
			...
			<li class="accordion-group"><a
				...
				data-parent="#sidebar_menu" href="#collapse2"> <img
					src="<?php echo base_url();?>/img/menu_icons/widgets.png">My Profile
			</a>
				<ul id="collapse2" class="accordion-body collapse">
					<li><a href="<?php echo site_url('dashboard');?>">My personal info</a></li>
					<li><a href="<?php echo site_url('dashboard');?>">My money</a></li>
					<li><a href="<?php echo site_url('dashboard');?>">My settings</a></li>
					<li><a href="<?php echo site_url('dashboard');?>">My selling tools</a></li>
				</ul>
			</li>
		</ul>
		<!-- End sidebar_box -->
