...
<head>
  ...
  <link rel="shortcut icon" href="<?=base_url()?>/css/images/favicon.png">
  <!-- Le styles -->
      ...
      <div id="loading" class="other_pages">
        ...
        <div class="row-fluid">
          <div class="row-fluid">
			...
			<a href="index.html"style="background: url(../images/tenpay3.png) 0 0 no-repeat;"></a></div>
        ...
        <div class="row-fluid container">
          ...
          <?php 
          	if(isset($message) && $message="failed"){
          		?>
          		<h4>Your username or email is existing, please re enter.</h4>
          		<?php
          	}else{?>
				<h4>Please enter your username and email to register.</h4>
			<?php }?>
              
            </div>
          <form class="form-horizontal row-fluid" action="<?=site_url("registry/register")?>" method="post">
