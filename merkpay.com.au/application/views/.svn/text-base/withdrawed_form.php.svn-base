    ...
    <div class="row-fluid">
      <div class="span7">
        <div class="box gradient">
          <div class="title">
            <h3>
            <i class="icon-book"></i><span>Withdraw successfully</span>
            </h3>
          </div>
          <div class="content">

              <div class="form-row control-group row-fluid">
                <label>Form this balance, the amount <?php echo $data['amount']?>AUD has been withdrawed successfully to <?php echo $data['toperson']?>.</label>
				<label>The availabe amount is <?php echo $data['left'];?>AUD now. </label>              
              </div>
          </div>
        </div>
      </div>
