        ...
        <div class="row-fluid container">
          <div class="content">
            <div class="message row-fluid">
					<h2>Dear Customer:</h2>
					<p>Your number: <?php echo $phoneNumber?></p>
					<p>You need to pay $<?php echo  $amount?> to <?php echo $companyid?>. Please input your credit card information：</p>
            </div>
					<form id="payform" action="tenpay_cc.php" method="post">
<!--             <div class="control-group row-fluid">  -->
<!--               <div class="controls row-fluid input-append"> -->
<!--                 <input type="text" name="amount" id="amount"  placeholder="Amount"  class="row-fluid" value=""> <span class="add-on"><i class="icon-user"></i></span> -->
<!--               </div> -->
<!--             </div> -->
            <div class="control-group row-fluid">
              <label class="row-fluid " for="inputEmail">Card Number</label>
              <div class="controls row-fluid input-append">
            ...
            <div class="control-group row-fluid">
              <label class="row-fluid " for="inputEmail">Card Name</label>
              <div class="controls row-fluid input-append">
            ...
            <div class="control-group row-fluid">
              ...
              <div class="control-group row-fluid">
              <label class="row-fluid " for="inputPassword">CVV <div class="pull-right"><a class="muted"><small>Type three number</small></a></div></label>
              <div class="controls row-fluid input-append">
