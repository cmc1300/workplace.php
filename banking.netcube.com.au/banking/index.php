...
<div class="container">
<div class="loginDev">
<form name="loginForm" id="form" class="form" method="post" action="login.php" role="form" onsubmit="return checkOperatorPassword()" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8">
