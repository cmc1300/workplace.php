...
$(window).scroll(function() {
    ...
    if (value > 50)
        $("header").css("background", "#fff").css("padding", "0px 0px 13px").css("box-shadow", "0 0 10px #888");
    else
        $("header").css("background", "transparent").css("padding", "11px 0px 20px").css("box-shadow", "none");
});
