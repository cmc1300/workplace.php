...
<div class="demo">
	...
	<button type="submit" onclick="location.reload();" style="width:200px;height:50px;float:right;background-color:pink;border:0">
		<p style=" font-size: 20px;margin:0"><b>Refresh this page</b></p>
	</button>
		...
		<tbody>
			<?php 
			   	for ($i=0; $i < count($accountListing); $i++) {
					...
					$rowString .= "<td>" . strtoupper($date->format('D')) . "</td>";
					//$rowString .= "<td>" . $rowArray["clientIP"] . "</td>";
					//$rowString .= "<td>" . $rowArray["website"] . "</td>";
	...
	<p>End of this <?php echo count($accountListing);?>-record page, thanks!</p>
