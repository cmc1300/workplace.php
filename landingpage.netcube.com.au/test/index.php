...
<table border="0" align="center">
  <tr>
  	  <td align="right" style="vertical-align:top;">
  		<img src="img/NC-landingxmas-LP-01.png" width="915" alt="" border="0">
  		...
  		<div style="width: 915px;vertical-align:top;padding-top:20px;padding-left:60px;">
			...
			<p>For only <strong>$39.95 per month </strong>you can now have <strong>Unlimited ADSL 2+/NBN internet</strong> with your BYO home phone. 
...
&bull; No NetCube line rental bundling required</p></td>
...
Contact us now on 1300 58 68 78 and quote <strong style="color:#00a1df">Our Online Promo Code: GOOADW39  </strong></p><br>
			<!--  
			<table border="0">
			  <tr>
			...
			# Mininum cost for month-to-month is $178.95 ($39.95 monthly fee + $149 setup fee). </p>
			<br><br>
		</div>
  		</div>		
  	  </td>
      ...
      <td align="left" style="vertical-align:top;">
        ...
        <form method="post" action="./landpageSeptAdd.php" onsubmit="return checkInputParameters()" id="form1" name="form1">
		  ...
		  <div class="form-group" style="background-image:url(img/NC-dealer-whiteside-bg.png); background-size:100% 100%; background-repeat:no-repeat;">
			...
			<div style="padding-top:10px;padding-left:15px;padding-right:15px">
				<input type="text" disabled class="form-control" style="background-color:#F0F0F0" name="code" id="code" value="Promo Code: VIC4021">
		...
		<table border="0">
			  ...
			  <tr>
			    ...
			    <strong style="color:#00a1df;font-size:32px">VIC4021</strong>
			    &nbsp;
			    </td>
			  </tr>
		</table>
