...
<table border="0" align="center">
  <tr>
  	  <td align="right" style="vertical-align:top;">
  		...
  		<div style="width: 915px;vertical-align:top;padding-top:20px;padding-left:20px;">
			<div align="left" >
			<h1 style="color:#00a1df">订购ADS2+ / NBN极速无限量智能宽带娱乐套餐 </h1>
			<p>NetCube是由澳洲最大的网络提供商支持。</p>
            <p>
              每月只需$89.95起，就可拥有ADSL2+/ NBN无限量网络，另赠高清智能电视 。一次拥有宽带, 电视, 电话，把所有精彩都一起搬回家。</p> 
            <br>
            
            <table width="100%" border="0">
  <tr>
    <td style="background-image:url(img/NC-dealer-Recreational-LP-greybg_box.png); background-repeat:no-repeat; width:400px; height:150px; background-size:100% 100%;"><p style="padding: 10px 10px 0px 20px; font-size:16px;  line-height:2"><strong>无限量ADSL2+/ NBN</strong><br>
&bull; 无额外收费<br>
&bull; 无限制高峰/非高峰时间<br>
&bull; 免费Google应用电子邮件帐户<br>
&bull; 无网络流量限制</p></td>
            <td style="width:5px">&nbsp;</td>
   <td style="background-image:url(img/NC-dealer-Recreational-LP-greybg_box.png); background-repeat:no-repeat; width:400px; height:150px; background-size:100% 100%; vertical-align:top"><p style="padding: 10px 10px 0px 20px; font-size:16px; line-height:2"><strong>娱乐套餐特点</strong><br>
&bull;  包括高清智能电视<br>
&bull;  包括智能电视棒<br>
&bull;  包括无线智能路由器<br>
&bull;  由澳洲最大的网络提供商支持</p></td>
  </tr>
 
</table>
			
			<br><br>
			<p>如有任何兴趣或疑问，请在右上方提交你的资料，我们将会尽快回复并提供你有关套餐更详细的资料。<br>

现在就联系我们1300 58 68 78 并报上<strong style="color:#00a1df">我们的在线促销代码： GOOADWTV  </strong></p><br>
			<!--  
			<table border="0">
			  <tr>
			...
			# Mininum cost is $2307.70 includes setup and delivery fees for 24 months.<br>
			^ Included countries / regions.<br>
			† Terms and conditions apply. <br>
			* Free International Phone calls are made through NetCube Premium router, NetCube smart dialler app. <br>
&nbsp;&nbsp;The NetCube smart dialer app consumes data in accordance to your existing carrier agreement. <br> </p>
			<br><br>
		</div>
  		</div>		
  	  </td>
      ...
      <td align="left" style="vertical-align:top;">
        ...
        <form method="post" action="./landpageSeptAdd.php" onsubmit="return checkInputParameters()" id="form1" name="form1">
		  ...
		  <div class="form-group" style="background-image:url(img/NC-dealer-whiteside-bg.png); background-size:100% 100%; background-repeat:no-repeat;">
			<div style="padding-top:10px;padding-left:15px;padding-right:15px"></div>
			<div style="padding-top:10px;padding-left:15px;padding-right:15px">
		    	...
		    	<input type="text" class="form-control" style="background-color:#F0F0F0" name="phone" id="phone" placeholder="Phone* e.g. 0412345678">
		    </div>
		    <div style="padding-top:10px;padding-left:15px;padding-right:15px">
				<input type="text" class="form-control" style="background-color:#F0F0F0" name="email" id="email" placeholder="Email address*">
			</div>
			<div style="padding-top:10px;padding-left:15px;padding-right:15px">
				<input type="text" disabled class="form-control" style="background-color:#F0F0F0" name="code" id="code" value="促销代码: GOOADWTV">
		...
		<table border="0">
			  <tr>
			    <td style="font-size:26px; width: 250px; padding-bottom:10px; text-align:center"><strong style="color:#00a1df">促销代码</strong></td>
			  </tr>
			  <tr>
			    ...
			    <strong style="color:#00a1df;font-size:32px">GOOADWTV</strong>
			    &nbsp;
			    </td>
			  </tr>
		</table>
