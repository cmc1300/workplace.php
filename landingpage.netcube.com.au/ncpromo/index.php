...
<table border="0" align="center">
  <tr>
  	  <td align="right" style="vertical-align:top;">
  		<img src="img/NC-landing_NCPROMO-LP-01.png" width="915" alt="" border="0">
  		...
  		<div style="width: 915px;vertical-align:top;padding-top:20px;padding-left:60px;">
			...
			<p>For only <strong>$69.95 per month </strong>you can now have <strong>Unlimited ADSL 2+/NBN internet</strong> plus <strong>Unlimited Local & National Calls</strong>.
NetCube is powered by Australias largest network provider. </p> <br>
...
&bull; Unlimited local and national calls <br>
&bull; Free setup for 24 months<br>
&bull; Free router for 24 months<br>
&bull; Line rental included<br>
&bull; International calls included</p></td>
...
&bull; FREE google powered email account<br>
...
Contact us now on 1300 58 68 78 and quote <strong style="color:#00a1df">Our Online Promo Code: NCPROMO  </strong></p><br>
			<!--  
			<table border="0">
			  <tr>
           ...
           # Free Unlimited local & national calls for the contract term. <br />
			# Mininum cost is $1757.80 (includes upfront fees) for 24 months.</p>
			<br><br>
		</div>
  		</div>		
  	  </td>
      ...
      <td align="left" style="vertical-align:top;">
        ...
        <form method="post" action="./landpageSeptAdd.php" onsubmit="return checkInputParameters()" id="form1" name="form1">
		  ...
		  <div class="form-group" style="background-image:url(img/NC-dealer-whiteside-bg.png); background-size:100% 100%; background-repeat:no-repeat;">
			...
			<div style="padding-top:10px;padding-left:15px;padding-right:15px">
				<input type="text" disabled class="form-control" style="background-color:#F0F0F0" name="code" id="code" value="Promo Code: NCPROMO">
		...
		<table border="0">
			  ...
			  <tr>
			    ...
			    <strong style="color:#00a1df;font-size:32px">NCPROMO</strong>
			    &nbsp;
			    </td>
			  </tr>
		</table>
