...
$languagArray = explode(",",$language);
$language = trim($languagArray[0]);
if($language == "zh-CN") {
	header("Location: ./cn/");
	die();
} */
  ...
  <tr>
  	  <td align="right" style="vertical-align:top;">
  		...
  		<div style="width: 915px;vertical-align:top;padding-top:20px;padding-left:20px;">
			<div align="left" >
			<h1 style="color:#00a1df">Get Entertainment Bundle with Unlimited Internet</h1>
			<p>NetCube is powered by Australia's largest network provider. </p>
            <p>
From only <strong>$89.95 per month </strong>you can now have <strong>Unlimited ADSL 2+/NBN internet</strong> that comes with a <strong>FULL HD LED TV</strong>.
</p> <br>
            
            <table width="100%" border="0">
  <tr>
    <td style="background-image:url(img/NC-dealer-Recreational-LP-greybg_box.png); background-repeat:no-repeat; width:400px; height:150px; background-size:100% 100%;"><p style="padding: 10px 10px 0px 20px; font-size:16px;  line-height:2"><strong>Unlimited ADSL2+/ NBN</strong><br>
&bull; No excess charges<br>
&bull; No peak/off-peak times<br>
&bull; FREE Google Apps email account<br>
&bull; No Data Limit</p></td>
...
&bull;  Full HD LED TV - INCLUDED<br>
&bull;  Smart Adaptor -  INCLUDED <br>
&bull;  Smart WiFi Router - INCLUDED<br>
...
Contact us now on 1300 58 68 78 and quote <strong style="color:#00a1df">Our Online Promo Code: 1MONTHFREE  </strong></p><br>
			<!--  
			<table border="0">
			  <tr>
      ...
      <td align="left" style="vertical-align:top;">
        ...
        <form method="post" action="./landpageSeptAdd.php" onsubmit="return checkInputParameters()" id="form1" name="form1">
		  ...
		  <div class="form-group" style="background-image:url(img/NC-dealer-whiteside-bg.png); background-size:100% 100%; background-repeat:no-repeat;">
			...
			<div style="padding-top:10px;padding-left:15px;padding-right:15px">
				<input type="text" disabled class="form-control" style="background-color:#F0F0F0" name="code" id="code" value="Promo Code: 1MONTHFREE">
		...
		<table border="0">
			  ...
			  <tr>
			    ...
			    <strong style="color:#00a1df;font-size:32px">1MONTHFREE</strong>
			    &nbsp;
			    </td>
			  </tr>
		</table>
